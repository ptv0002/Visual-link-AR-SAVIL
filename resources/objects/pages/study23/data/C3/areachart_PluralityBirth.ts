...
const Areachart_PluralityBirth: DataModule = {
    ...
    data: [        
        { x: .233, y: .112, width: 7, height: 4.2, data: { id: "quintuplets", group_id: "Prime_Numbers" } },
        { x: .577, y: .117, width: 5, height: 3.7, data: { id: "triplets", group_id: "Prime_Numbers" } },
        { x: .652, y: .117, width: 4.5, height: 3.8, data: { id: "twins", group_id: "Prime_Numbers" } }
    ]
}
