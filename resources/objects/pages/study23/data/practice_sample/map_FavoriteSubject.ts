...
const Map_FavoriteSubject: DataModule = {
    ...
    data: [
        { x: .425, y: .55, width: 6.8, height: 5.5, data: { id: "compTech", letter: "Technology" } },
        { x: .708, y: .284, width: 6.3, height: 3.2, data: { id: "math1", letter: "Mathematics" } },
        { x: .792, y: .429, width: 6.6, height: 3, data: { id: "math2", letter: "Mathematics" } }
    ]
}
