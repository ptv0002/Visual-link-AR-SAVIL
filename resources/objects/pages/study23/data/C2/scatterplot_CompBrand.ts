...
const Scatterplot_CompBrand: DataModule = {
    ...
    data: [
        { x: .184, y: .54, width: 1.4, height: 1.8, data: { id: "wellsfargo", letter: "CA,US" } },
        { x: .488, y: .757, width: 1.4, height: 2, data: { id: "netflix", letter: "CA,US" } },
        { x: .939, y: .696, width: 1.3, height: 1.8, data: { id: "tesla", letter: "TX,US" } }
    ]
}
